...
bbd.design(6)
bbd.design(7)
bbd.design(4,blockname="blocks")
bbd.design(5,blockname="blocks")
bbd.design(3,factor.names=Letters[23:25])
bbd.design(3,factor.names=list(X=c(0,10),Y=c(-10,+10),Z=c(223,277)))
bbd.design(3,blockname="blocks",factor.names=Letters[23:25])
plan <- bbd.design(3,blockname="blocks",factor.names=list(X=c(0,10),Y=c(-10,+10),Z=c(223,277)))
design.info(plan)
run.order(plan)
desnum(plan)
bbd.design(4,factor.names=Letters[22:25])
bbd.design(4,factor.names=list(W="",X=c(0,10),Y=c(-10,+10),Z=c(223,277)))
bbd.design(4,blockname="blocks",factor.names=Letters[22:25])
bbd.design(4,blockname="blocks",factor.names=list(W="",X=c(0,10),Y=c(-10,+10),Z=c(223,277)))

## randomize=FALSE
run.order(bbd.design(7,randomize=FALSE))
run.order(bbd.design(4,blockname="blocks",randomize=FALSE))
